import'dart:convert';
import 'package:purplestage/feature/auth/view/update_profile_screen.dart';
...
class RouteHelper {
  ...
  static const String eventList = '/event-lists';
  ...
  static String getProviderResultRoute({String? queryText, String? fromPage}) {
    ...
    //   data = base64Encode(encoded);
    // }
    return '$providerDetailsScreen?id=${queryText}';
  }
  ...
  static String getEventRoute() => eventList;
  ...
  static List<GetPage> routes = [
    ...
    GetPage( name:eventList, page:() => getRoute(const EventListScreen(),)),
