...
class AppConstants {
  ...
  static const String appName = 'PurpleStage';
  ...
  static const String providerSuggestion = '/api/v1/customer/provider/provider-suggestion';
  ...
  static const String getEventList = '/api/v1/customer/event-lists';
