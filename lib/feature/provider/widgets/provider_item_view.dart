...
class ProviderItemView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
   ...
   // print("providerservice ${providerData.subscribedServices}");
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Row(crossAxisAlignment: CrossAxisAlignment.center,children: [
                    ...
                    Expanded(
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start,mainAxisAlignment: MainAxisAlignment.center,children: [
                        ...
                        // Row(children: [
                        //   Flexible(
                        //     child: Text(providerData.contactPersonPhone??"", style: ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                        //       maxLines: 2, overflow: TextOverflow.ellipsis,
                        //     ),
                        //   ),
                        //   const SizedBox(width: Dimensions.paddingSizeExtraLarge,)
                        ...
                        // Row(children: [
                        //   Flexible(
                        //     child: Text(providerData.companyPhone??"", style: ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                        //       maxLines: 2, overflow: TextOverflow.ellipsis,
                        //     ),
                        //   ),
                        //   const SizedBox(width: Dimensions.paddingSizeExtraLarge,)
                  ...
                  (subcategories.isNotEmpty) ? Padding( padding: const EdgeInsets.symmetric(vertical: 4, horizontal: 5),
                    child: Text("Expertise: ",
                      style: ubuntuRegular.copyWith(fontSize: Dimensions.fontSizeSmall,color: Colors.black, fontWeight: FontWeight.bold), maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                    ),
                  ): const SizedBox(height: Dimensions.paddingSizeSmall,),
                  (subcategories.isNotEmpty) ? Padding( padding: const EdgeInsets.symmetric(vertical: 4, horizontal: 5),
                    child: Text(subcategories,
                      style: ubuntuRegular.copyWith(fontSize: Dimensions.fontSizeSmall,color: Colors.black), maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                    ),
                  ): const SizedBox(height: Dimensions.paddingSizeSmall,),
