...
import 'package:purplestage/feature/provider/widgets/provider_filter_view.dart';
import 'package:purplestage/feature/provider/widgets/provider_item_view.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                PaginatedListView(
                  ...
                  await providerBookingController.getProviderList(offset, false),
                  ...
                  itemView: GridView.builder(
                    ...
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                      ...
                      /// 👇 IMPORTANT: USE RATIO INSTEAD OF FIXED HEIGHT
                    ...
                    itemBuilder: (context, index) {
                      return ProviderItemView(
                        fromHomePage: false,
                        providerData: providerBookingController.providerList![index],
                        index: index,
                      );
                    },
                  ),
