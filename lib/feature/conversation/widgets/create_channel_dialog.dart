                              ...
                              Row(
                                  ...
                                  children: [
                                    if(widget.providerId != null)
                                      TextButton(
                                        onPressed:(){
                                          if(widget.providerData?.chatEligibility == true){
                                            String name = bookingDetailsContent.provider!.companyName!;
                                            String image = bookingDetailsContent.provider?.logoFullPath ?? "";
                                    ...
                                    if(widget.serviceManId != null)
                                      TextButton(
                                        onPressed:(){
                                          ...
                                          String image = bookingDetailsContent.serviceman?.user?.profileImageFullPath ??"";
